...
ESP-CAM尽管在单片机中性能不俗，但是拿来跑机器视觉必备的OpenCV还是有点弱，尽管是可以的但会卡成PPT，况且如果遇到高阶玩法还需要自己编译相应的库。

最最最主要，自从ChatGPT掀起的**AI**浪潮，既然拿到了视频流不得随便跑点模型，比如下面，图片随便从网上截的，加入了骨骼点识别。

![骨骼点识别](https://cdn.staticaly.com/gh/zhendehanzi/Blog-Images-1@master/骨骼点识别.4m57nfr6iug0.webp)

​									（图片来源于网络，效果为AlphaPose模型加持）

同样的，我们的ESP-CAM UDP推流，也可以很快速的接入很多主流的图像类深度学习模型中进行功能验证

跑题了，本次使用到的实现机器视觉的方法与深度学习无关，目的是为了兼容像树莓派、旧PC之类的设备也可以轻松运行，因此要用最简单的方式实现能令人满意的效果。

先看一段GIF

![20230527-09'25'2620235282084032](https://cdn.staticaly.com/gh/zhendehanzi/Blog-Images-1@master/20230527-09'25'2620235282084032.4q1brjibqfi0.gif)
...
在判断jpeg图片的完整性中，用文件头和文件尾便可以进行巧妙的判断
